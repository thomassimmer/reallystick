...
class ChallengeStatisticDataModel extends Equatable {
  ...
  factory ChallengeStatisticDataModel.fromJson(
    ...
    return ChallengeStatisticDataModel(
      challengeId: jsonObject['challenge_id'] as String,
  ...
  ChallengeStatistic toDomain() {
    return ChallengeStatistic(
