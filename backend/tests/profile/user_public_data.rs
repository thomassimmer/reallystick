...
use reallystick::features::profile::structs::{
    models::UserPublicData, requests::GetUserPublicDataRequest, responses::UsersResponse,
};
use uuid::Uuid;
...
pub async fn user_gets_other_user_data(
    ...
    let req = test::TestRequest::post()
        ...
        .set_json(&GetUserPublicDataRequest { user_ids })
        .to_request();
...
pub async fn user_can_get_other_users_public_data() {
    ...
    let users = user_gets_other_user_data(&app, &access_token, vec![user_id, user_id2]).await;
