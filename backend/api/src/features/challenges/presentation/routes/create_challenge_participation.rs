...
use crate::{
    ...
    features::{
        ...
        challenges::{
            ...
            domain::entities::challenge_participation::ChallengeParticipation,
...
pub async fn create_challenge_participation(
    ...
    let challenge = match challenge_repo
    ...
    match participation_repo
        .get_ongoing_by_user_and_challenge_with_executor(
    ...
    let create_challenge_participation_result = participation_repo
        .create_with_executor(&challenge_participation, &mut *transaction)
        .await;
            ...
            notification_service
                .generate_notification(
                    ...
                    &translator.translate(
                        &creator.locale,
                        "user-joined-your-challenge-title",
                        None,
                    ),
                    &translator.translate(
                        &creator.locale,
