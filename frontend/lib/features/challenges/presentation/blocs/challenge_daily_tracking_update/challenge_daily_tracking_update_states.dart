...
final class ChallengeDailyTrackingUpdateFormState extends Equatable {
  ...
  const ChallengeDailyTrackingUpdateFormState({
  ...
  ChallengeDailyTrackingUpdateFormState copyWith({
    ...
    return ChallengeDailyTrackingUpdateFormState(
