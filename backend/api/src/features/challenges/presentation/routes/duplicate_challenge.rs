...
use crate::{
    ...
    features::{
        ...
        challenges::{
            ...
            domain::entities::{
                challenge::Challenge, challenge_daily_tracking::ChallengeDailyTracking,
            },
...
pub async fn duplicate_challenge(
    ...
    let get_challenge_result = challenge_repo
        .get_by_id_with_executor(params.challenge_id, &mut *transaction)
        .await;
    ...
    if let Err(e) = challenge_repo
        .create_with_executor(&challenge_to_create, &mut *transaction)
        .await
    {
        error!("Error: {}", e);
    ...
    let get_challenge_daily_trackings_result = daily_tracking_repo
        .get_by_challenge_id_with_executor(params.challenge_id, &mut *transaction)
        .await;
    ...
    let create_challenge_daily_tracking_result = daily_tracking_repo
        .create_batch_with_executor(&challenge_daily_trackings_to_create, &mut *transaction)
        .await;
