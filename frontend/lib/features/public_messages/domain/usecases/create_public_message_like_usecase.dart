...
class CreatePublicMessageLikeUsecase {
  final PublicMessageLikeRepository publicMessageLikeRepository;

  CreatePublicMessageLikeUsecase(this.publicMessageLikeRepository);

  Future<Either<DomainError, void>> call({
    required String messageId,
  }) async {
    return await publicMessageLikeRepository.createPublicMessageLike(
      messageId: messageId,
    );
  }
}
